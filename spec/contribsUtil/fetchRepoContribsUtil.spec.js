...
const fetchAllRepoContribs = require('../../src/utils/contribsUtil/fetchAllRepoContribs');
const fetchRepoContribs = require('../../src/utils/contribsUtil/fetchRepoContribs');
...
describe('fetchRepoContribsUtil.js', () => {
  ...
  beforeAll(() => {
    ...
    fetchAllRepoContribs.fetchAllRepoContribs = jest.fn(() => {
      return true;
    });
    fetchRepoContribs.fetchRepoContribs = jest.fn(() => {
      return true;
    });
  });
  ...
  it('directs to appropriate to function - for plots2', () => {
    ...
    return fetchRepoContributorsUtil
