document.addEventListener('DOMContentLoaded', (e) => {
  $.getJSON('../../config.json')
    .done((data) => {
      ...
      $('#createissue').attr(
        'href',
        `https://github.com/${data.org}/${data['default-repository']}/issues/new/choose`
      );
      $('#support-issues').attr(
        'href',
        `https://github.com/${data.org}/${data['default-repository']}/labels/${data['support-issue-label']}`
      );
      ...
      $('#newcomer-issues-link').attr(
        'href',
        `https://github.com/${data.org}/${data['default-repository']}/labels/${data['issue-label-for-newcomer']}`
      );
      $('#help-wanted-issues').attr(
        'href',
        `https://github.com/${data.org}/${data['default-repository']}/labels/${data['help-wanted-issue-label']}`
      );
      ...
      $('.guidelines-link').each(function () {
        $(this).attr(
          'href',
          `${data['newcomer-welcoming-guidelines-page-link']}`
        );
      });
      $('#other-ways-to-support').attr(
        'href',
        `${data['other-ways-to-support-guidelines-link']}`
      );
